...
###性別與年齡之間的關係
由年齡組成中，可發現年齡介於20-60歲佔最多數(約73%)，而0-20歲間之年輕人次之(約24%)，而在性別角度上分析，可發現整艘船男性多於女性，與看完電影中之想像不一樣，在年齡介於20-60歲之中，男性更是多於女性將近兩倍數量
```{r}
table(Titanic$gender,Titanic$age)
```

###性別與票價之間的關係  
由性別與票價中，可發現男性具有能力購買票價100以上僅佔3%，而女性為9%，顯示出那年代大多數女性較男性富有
```{r}
...
###尋找性別與存活之間的關係
先前已得知船上之男性人數多於女性人數，而在分析存活人數與性別中可發現，
就個別分析死亡率中，男性佔82%、女性35%，而存活率男性性佔18%、女性65%，若以總體人數分析，男性死亡率為51%、存活率僅11%女性總體死亡率僅13%，存活率為24%，顯示出女性比起男性能更有機會存活下來
